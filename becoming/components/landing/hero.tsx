...
export function Hero() {
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center px-6 pt-28 pb-16 text-center">
      {/* Cinematic golden light spilling from the top-right corner */}
      <div
        className="pointer-events-none absolute inset-0 -z-10 [mask-image:radial-gradient(ellipse_80%_80%_at_50%_40%,black,transparent_85%)]"
        aria-hidden="true"
      >
        <SideRays
          origin="top-right"
